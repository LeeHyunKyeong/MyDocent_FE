...
const Button: React.FC<{ button: ButtonData; onPress: () => void }> = ({
  button,
  onPress,
}) => (
  <TouchableOpacity
    style={[styles.button, button.isClicked && styles.buttonClicked]}
    onPress={onPress}
  >
    <Text
      style={[styles.buttonText, button.isClicked && styles.buttonTextClicked]}
    >
      {button.label}
    </Text>
  </TouchableOpacity>
            ...
            <View style={styles.textInputContainer}>
              ...
              <View style={styles.buttonRow}>
                ...
                <TouchableOpacity
                  style={[
                    styles.iconButton,
                    isSendClicked && styles.sendButtonActive,
                  ]}
